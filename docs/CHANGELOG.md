...
### Added
- Complete agent-based development system (`docs/agents/`)
- Comprehensive project documentation (`CLAUDE.md`, `plan.md`, `PROGRESS.md`, etc.)
- Database schema design (`SCHEMA.md`)
- Visual & UX reference (`VISUAL.md`)
- TypeScript type definitions mirroring SQLite schema (`TYPES.md`)
